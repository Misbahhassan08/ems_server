...
from .views import  get_unassigned_users, assign_user_to_admin
urlpatterns = [
    ...
    path('Generator_project/', Generator_project, name='Generator_project'),
    path('Grid_export_project/', Grid_export_project, name='Grid_export_project'),
    path('Solar_import/', Solar_import, name='Solar_import'),
    path('Generator_import/', Generator_import, name='Generator_import'),
    path('Grid_import/', Grid_import, name='Grid_import'),
    path('Grid_export/', Grid_export, name='Grid_export'),
